...
import { useContractorFormFields } from "@src/hooks/contractor/useContractorFields";
...
const Users = () => {
  ...
  const { data: apiData, isLoading, isFetching } = useGetAllContractor(5);
  ...
  return (
    <div>
      <PageTitle title="User" description="Manage Your Users Effectively" />
      ...
      <Dialog
        ...
        <DialogContent className="min-w-max w-full rounded-sm">
          <DialogHeader>
            <DialogTitle>{view ? "View User" : "Add New User"}</DialogTitle>
