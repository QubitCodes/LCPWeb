...
const Workers = () => {
  ...
  const { data: apiData, isLoading, isFetching } = useGetAllContractor(4);
  ...
  return (
    <div>
      <PageTitle title="Worker" description="Manage Your Workers Effectively" />
      ...
      <Dialog
        ...
        <DialogContent className="min-w-max w-full rounded-sm">
          <DialogHeader>
            <DialogTitle>{view ? "View Worker" : "Add New Worker"}</DialogTitle>
            <DialogDescription>View Worker details</DialogDescription>
          </DialogHeader>
