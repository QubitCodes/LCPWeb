...
const Contractor = () => {
  ...
  const { data: apiData, isLoading, isFetching } = useGetAllContractor(3);
  ...
  return (
    <div>
      <PageTitle
        title="Contractor"
        description="Manage Your Contractors Effectively"
      />
      ...
      <Dialog
        ...
        <DialogContent className="min-w-max w-full rounded-sm">
          <DialogHeader>
            <DialogTitle>
              {view ? "View Contractor" : "Add New Contractor"}
            </DialogTitle>
            <DialogDescription>View contractor details</DialogDescription>
          </DialogHeader>
        ...
        ))}
      {
        <DataTable
          ...
          ButtonTitle="Add New Contractor"
