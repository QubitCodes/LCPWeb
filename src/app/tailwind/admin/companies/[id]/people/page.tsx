 ...
 * Accessible via /tailwind/admin/companies/[id]/people?tab=supervisors|workers
 *
...
export default function CompanyPeoplePage() {
    ...
    useEffect(() => {
        ...
        setActions(
            <button
                onClick={() => router.push('/tailwind/admin/companies')}
                ...
                <button
                    onClick={() => {
                        if (activeTab === 'workers') {
                            ...
                            router.push(`/tailwind/admin/companies/${companyId}/workers/${row.original.id}`);
                        } else {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex gap-1 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-1 w-fit">
                <button
                    onClick={() => router.replace(`/tailwind/admin/companies/${companyId}/people?tab=supervisors`)}
                ...
                <button
                    onClick={() => router.replace(`/tailwind/admin/companies/${companyId}/people?tab=workers`)}
