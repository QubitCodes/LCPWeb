...
interface VerticalTabLayoutProps {
    /** Array of tab definitions with hrefs (URL slugs) - Legacy approach */
    tabs?: VerticalTab[];
    /** Section title displayed above the tabs - Legacy approach */
    sectionTitle?: string;
    /** Grouped tab definitions - New approach */
    tabGroups?: VerticalTabGroup[];
...
export default function VerticalTabLayout({
    ...
    // Normalize tabs and groups logic
    const groups = tabGroups || (tabs ? [{ title: sectionTitle || '', tabs }] : []);
